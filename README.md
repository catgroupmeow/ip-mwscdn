...
```bash
89.169.90.8   # Основной
89.169.90.9   # Резервный
89.169.90.10  # Рекомендуемый
89.169.90.11  # Дополнительный
```
...
```bash
# Тестовый запрос
curl --resolve cdn-mws.yourdomain.com:443:89.169.90.10 https://cdn-mws.yourdomain.com
